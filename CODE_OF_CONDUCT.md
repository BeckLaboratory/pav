...
When an incident does occur, it is important to report it promptly. **Please report violations to
Peter Audano (peter.audano@jax.org)**. Alternatively, you may consult with Christine Beck (christine.beck@jax.org) or
The Jackson Laboratory HR department (hrhelp@jax.org) for guidance.
...
Complaints will be reviewed confidentially and appropriate responses will be taken including suspension and
permanent bans from the project as necessary. We reserve the right to remove any content contributed by a violator
including code and discussions. 
...
Some modifications to the original code of conduct were made using the
[Atom project Code of Conduct](https://github.com/atom/atom/blob/master/CODE_OF_CONDUCT.md) as a guide.
