...
def filter_trim(
    ...
    """
    Filter a variant table by trimmed alignments. Retain only variants that are not fully within non-trimmed regions.

    Args:
        df: Variant table.
        df_align: Alignment table this variant table was generated from. The align_index field in the variant table
