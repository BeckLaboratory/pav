...
class _GlobalImportScope:
    ...
    :ivar package_path: Name of the module where import statements are relative to (e.g. 'pavcall.lgsv.interval' for
        imports in 'pavcall/lgsv/interval.py').
...
class GlobalImport:
    ...
    def push(
        ...
        :param package_path: Name of the module where this import statement is found (e.g. 'pavcall.lgsv.interval' if
            the import statements are in 'pavcall/lgsv/interval.py').
...
def alias_to_obj_dict(
    ...
    :param package_path: Name of the module where this import statement is found (i.e. 'pavcall.lgsv.interval' if the).
    :param import_statements: A string of newline-separated import statements.
