...
CONFIG_PARAM_LIST = [
    ...
    ConfigParam('redundant_callset', 'bool', False,
                ...
                advanced=True),
    ConfigParam('no_link_qry', 'bool', False,
    ...
    ConfigParam('align_agg_min_score', 'float', -10000.0, max=0.0,
    ...
    ConfigParam('align_agg_colinear_penalty', 'bool', True,
    ...
    ConfigParam('lg_off_gap_mult', 'float', pavlib.const.DEFAULT_LG_OFF_GAP_MULT,
                min=(1.0, False),
    ...
    ConfigParam('inv_max', 'int', 0, min=0, description='Maximum inversion size. Unlimited inversion size if value is 0.'),
